...
(function () {
  ...
  var quiz = (0, _jquery2['default'])('#quiz'); //Quiz div object

  // Display initial question
  displayNext();

  // Click handler for the 'next' button
  (0, _jquery2['default'])('#next').on('click', function (e) {
    e.preventDefault();
  ...
  (0, _jquery2['default'])('#prev').on('click', function (e) {
    e.preventDefault();
  ...
  (0, _jquery2['default'])('#start').on('click', function (e) {
    e.preventDefault();
  ...
  (0, _jquery2['default'])('.button').on('mouseenter', function () {
    (0, _jquery2['default'])(this).addClass('active');
  });
  (0, _jquery2['default'])('.button').on('mouseleave', function () {
  ...
  function createQuestionElement(index) {
    ...
    var question = (0, _jquery2['default'])('<p>').append(questions[index].question);
  ...
  function choose() {
    selections[questionCounter] = +(0, _jquery2['default'])('input[name="answer"]:checked').val();
  }

  // Displays next requested element
  function displayNext() {
    quiz.fadeOut(function () {
      (0, _jquery2['default'])('#question').remove();

      if (questionCounter < questions.length) {
        var nextQuestion = createQuestionElement(questionCounter);
        quiz.append(nextQuestion).fadeIn();
        if (!isNaN(selections[questionCounter])) {
          (0, _jquery2['default'])('input[value=' + selections[questionCounter] + ']').prop('checked', true);
        }

        // Controls display of 'prev' button
        if (questionCounter === 1) {
          (0, _jquery2['default'])('#prev').show();
        } else if (questionCounter === 0) {

          (0, _jquery2['default'])('#prev').hide();
          (0, _jquery2['default'])('#next').show();
        }
      } else {
  ...
  function displayScore() {
    var score = (0, _jquery2['default'])('<p>', { id: 'question' });
